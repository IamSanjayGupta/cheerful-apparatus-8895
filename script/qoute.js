import {subfooter,footer,subnavbar,topnavbar } from "../components/proto.js";
...
let quouteApproval = (event)=>{
    ...
    if(a.length > 2 && b.length > 2 && c.length > 2 && d.length > 2 && e.length > 2 && f.length > 2 && g.length > 2 && names.length > 2 && number.length > 2 && email.length > 2 && country.length >2){
